  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '/home/pzp/8bitworkshop-compilers/output/fs/fs65-atari.data';
      var REMOTE_PACKAGE_BASE = 'fs65-atari.data';
...
Module['FS_createPath']("/target/atarixl/drv", "mou", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_/home/pzp/8bitworkshop-compilers/output/fs/fs65-atari.data');

      };
      Module['addRunDependency']('datafile_/home/pzp/8bitworkshop-compilers/output/fs/fs65-atari.data');
    ...
    Module['removeRunDependency']('fs65-atari.js.metadata');
   }

   function runMetaWithFS() {
    Module['addRunDependency']('fs65-atari.js.metadata');
    var REMOTE_METADATA_NAME = Module['locateFile'] ? Module['locateFile']('fs65-atari.js.metadata', '') : 'fs65-atari.js.metadata';
    var xhr = new XMLHttpRequest();
