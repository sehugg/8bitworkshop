...
import { Platform, Preset, getExtensions_6502, getOpcodeMetadata_6502, getToolForFilename_6502 } from "../common/baseplatform";
...
class NewApple2Platform extends Base6502MachinePlatform<AppleII> implements Platform {
  ...
  getExtensions() { return [...getExtensions_6502(), ".lnk"]; }
