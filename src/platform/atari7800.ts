...
import { Platform, Base6502MachinePlatform, getExtensions_6502, getToolForFilename_6502 } from "../common/baseplatform";
...
class Atari7800Platform extends Base6502MachinePlatform<Atari7800> implements Platform {
  ...
  getExtensions() { return [...getExtensions_6502(), ".cc7800"]; }
