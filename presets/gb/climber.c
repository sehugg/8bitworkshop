...
const uint8_t sprite_tiles[] = {
  ...
  ,
  ...
  0x18,0x07,0x1F,0x1F,0x0F,0x3F,0x0F,0x37,0x3F,0x20,0x7F,0x7C,0x43,0x43,0x03,0x03,
  ...
  0x3F,0x3F,0x3F,0x7F,0x0F,0x6F,0x7F,0x60,0x7F,0x61,0x7E,0x7E,0x40,0x40,0x00,0x00,
  0xC8,0xC8,0xFC,0x34,0xFC,0x04,0xF8,0x08,0x40,0xA0,0x40,0xB0,0x00,0xE0,0x00,0xCC,
  0xD0,0xDC,0xF8,0xF8,0xF0,0xF0,0xC4,0x04,0xFC,0x0C,0xFC,0x8C,0x7C,0x7C,0x00,0x00,
  ...
  0xF8,0xF8,0xF8,0xF8,0xF8,0xC0,0xF8,0x00,0xF0,0xF0,0x00,0x00,0x00,0x00,0x00,0x00,
...
// 2x2 metasprite geometry for the 16x16 frames. Tiles are stored in
// sprite_tiles as UL, LL, UR, LR, and the metasprites use a top-left
// pivot. GBDK metasprite items are deltas from the previous sub-sprite.
const metasprite_t meta_normal[] = {
  METASPR_ITEM(0, 0, 0, 0),    // UL
  METASPR_ITEM(8, 0, 1, 0),    // LL
  METASPR_ITEM(-8, 8, 2, 0),   // UR
  METASPR_ITEM(8, 0, 3, 0),    // LR
  METASPR_TERM
};
const metasprite_t meta_mirror[] = {
  METASPR_ITEM(0, 8, 0, 0),    // UL -> right
  METASPR_ITEM(8, 0, 1, 0),    // LL -> right
  METASPR_ITEM(-8, -8, 2, 0),  // UR -> left
  METASPR_ITEM(8, 0, 3, 0),    // LR -> left
  METASPR_TERM
};
...
void put_2x2(byte x, byte y, byte frame, byte props, byte flip) {
  byte i, n;
  // move_metasprite writes raw OAM coords, so convert from screen space
  n = move_metasprite(flip ? meta_mirror : meta_normal,
                      SPR_BASE + frame*4, oam_off, x+8, y+16);
  // metasprite items clobber CGB palette / OBP select, so restore props
  for (i=0; i<n; i++)
    shadow_OAM[oam_off+i].prop = props | (flip ? S_FLIPX : 0);
}
