...
/*
Galaxy demo for Game Boy, ported from GBDK's examples/gb/galaxy.

Demonstrates the window layer: set_win_data() loads tile patterns
into the window's tile data range, and set_win_tiles() writes a map
into the window tile map. The window is scrolled by writing WX/WY.
Also uses fixed-point (fixed) positions/speeds, vsync, and the
...
/*{w:8,h:8,bpp:1,count:28,brev:1,np:2,pofs:1,sl:2}*/
...
/*{w:8,h:8,bpp:1,count:33,brev:1,np:2,pofs:1,sl:2}*/
...
/*{w:8,h:8,bpp:1,count:45,brev:1,np:2,pofs:1,sl:2}*/
...
#define NBDFRAMES 24                  /* Nb frames for the door */
#define NBSFRAMES 7                  /* Nb frames for the sprite */
#define WINSZX    128u                  /* Size of the picture in the window */
#define WINSZY    0x50u
...
#define FADESTEP  16                  /* Nb steps for the fading effect */
#define STARTFADE (6*FADESTEP)       /* Initial value for the fading effect */
