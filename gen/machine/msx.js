...
var MSX_KEYCODE_MAP = (0, emu_1.makeKeycodeMap)([
    [emu_1.Keys.UP, 0, 0x1],
...
class MSX1 extends vdp_z80_1.BaseZ80VDPBasedMachine {
    constructor() {
        super();
        ...
        this.init(this, this.newIOBus(), new audio_1.AY38910_Audio(new audio_1.MasterAudio()));
        this.bios = new util_1.lzgmini().decode((0, util_1.stringToByteArray)(atob(MSX1_BIOS_LZG)));
        // skip splash screen
        this.bios[0xdd5] = 0;
        this.bios[0xdd6] = 0;
        this.bios[0xdd7] = 0;
        ...
        return {
            read: (addr) => {
                ...
                switch (addr) {
                    ...
                    case 0xa2:
                        if (this.psg.currentRegister() == 14)
                            return ~this.inputs[JOY_INPUT_0]; // TODO: joy 1?
                        else
            ...
            write: (addr, val) => {
                ...
                switch (addr) {
                    case 0x98:
                        this.vdp.writeData(val);
                        break;
                    case 0x99:
                        this.vdp.writeAddress(val);
                        break;
                    case 0xa8:
                        this.slotmask = val;
                        break;
