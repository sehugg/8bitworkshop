    ...
    constructor(page, input, upper) {
        ...
        */
        ...
        this.windows = {
            ...
            3: new teletype_1.TeleType(null, true), // fake window for resizing
        };
        this.input = input;
        this.mainwnd.resolveInput = (resp) => {
            var s = resp.line;
...
class ZmachinePlatform {
    ...
    */
    ...
    inspect(ident) {
        return (0, baseplatform_1.inspectSymbol)(this, ident);
    }
    getDebugTree() {
        var root = {};
