...
exports.disassembleF8 = disassembleF8;
...
function disassembleF8(pc, b0, b1, b2) {
    let mn = '';
    let args = '';
    let nb = 1;
    let isaddr = false;
    if (b0 <= 0x07) {
        ...
        mn = 'BT';
        args = '' + (b0 & 0x07) + ',$' + (0, util_1.hex)(offset & 0xFFFF, 4);
        nb = 2;
        isaddr = true;
    }
    else if (b0 === 0x88) {
        ...
        const offset = (b1 & 0x80) ? (pc + 2 + b1 - 256) : (pc + 2 + b1);
        mn = 'BR7';
        args = '$' + (0, util_1.hex)(offset & 0xFFFF, 4);
        nb = 2;
        isaddr = true;
    }
    ...
    else if (b0 >= 0xA0 && b0 <= 0xA1) {
        mn = 'INS';
        args = '' + (b0 & 0x0F);
    }
    else if (b0 >= 0xA2 && b0 <= 0xA3) {
        mn = '???';
    }
    else if (b0 >= 0xA4 && b0 <= 0xAF) {
        mn = 'INS';
        args = '' + (b0 & 0x0F);
    }
    else if (b0 >= 0xB0 && b0 <= 0xB1) {
        mn = 'OUTS';
        args = '' + (b0 & 0x0F);
    }
    else if (b0 >= 0xB2 && b0 <= 0xB3) {
        mn = '???';
    }
    else if (b0 >= 0xB4 && b0 <= 0xBF) {
        mn = 'OUTS';
        args = '' + (b0 & 0x0F);
    }
    else if (b0 >= 0xC0 && b0 <= 0xCE) {
        mn = 'AS';
        args = regName(b0 & 0x0F);
    }
    else if (b0 === 0xCF) {
...
//# sourceMappingURL=disasmF8.js.map